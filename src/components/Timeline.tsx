  ...
  const events: TimelineEvent[] = [
    {
      ...
      description: "Maintaining a cumulative CGPA of 9.1 / 10.0 at IIIT Dharwad. Core focus: DBMS, Data Structures & Algorithms, Statistics, and Probability.",
      type: "academic",
    ...
    },
    {
      ...
      description: "Co-authored research on polarization detection across 22 languages. Developed the stacking classifier using QLoRA and Shannon entropy expert-routing.",
      type: "research",
    ...
    },
    {
      ...
      description: "Architected a C++ ONNX Runtime pipeline for limit order book predictions, achieving a 1.75x speedup (2.78ms latency) over Python.",
      type: "engineering",
    ...
    },
    {
      ...
      description: "Developed an XGBoost query routing classifier (97.3% F1 score) to route DSL inputs to SQL (Postgres) or Graph (Neo4j) backends.",
      type: "engineering",
    ...
    },
    {
      ...
      description: "Engineered a pgvector RAG database cache, reducing API token calls by 60% and cutting response times from 4.0s to 1.5s.",
      type: "engineering",
    ...
    },
    {
      ...
      description: "Completing honors track in Generative AI (Minor GPA: 9.0/10.0). Focus: LLM optimization, representations, and multi-agent loops.",
      type: "academic",
